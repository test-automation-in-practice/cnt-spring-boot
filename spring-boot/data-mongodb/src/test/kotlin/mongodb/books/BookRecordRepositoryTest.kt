...
internal class BookRecordRepositoryTest(
    ...
    @BeforeEach
    fun clearDatabase() = cut.deleteAll()

    @Test
    fun `document can be saved`() {
        val document = BookRecordDocument(randomUUID(), "Clean Code", "9780132350884")
    ...
    fun `document can be found by title`() {
        val d1 = cut.save(BookRecordDocument(randomUUID(), "Clean Code", "9780132350884"))
        val d2 = cut.save(BookRecordDocument(randomUUID(), "Clean Architecture", "9780134494166"))
        val d3 = cut.save(BookRecordDocument(randomUUID(), "Clean Code", "9780132350884"))
