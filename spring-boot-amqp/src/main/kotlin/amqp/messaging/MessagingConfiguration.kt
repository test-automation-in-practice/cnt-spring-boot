    ...
    @Bean fun bookEventMessageContainer(
        ...
        val messageListener = MessageListener { msg ->
            when (msg.messageProperties.consumerQueue) {
                CREATED_QUEUE_NAME -> eventHandler.handleCreatedEvent(objectMapper.readValue(msg.body, amqp.books.BookCreated::class.java))
                DELETED_QUEUE_NAME -> eventHandler.handleDeletedEvent(objectMapper.readValue(msg.body, amqp.books.BookDeleted::class.java))
            }
        }
